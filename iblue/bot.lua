...
if text:match("^[#!/]ban all$") and is_admin(msg.sender_user_id_, msg.chat_id_) and msg.reply_to_message_id_ then
	...
	-----------------------------------------------------------------------------------------------
	if text:match("^[#!/]demowner$") and is_iborn(msg.sender_user_id_) and msg.reply_to_message_id_ then
	...
	-----------------------------------------------------------------------------------------------
	if text:match("^[#!/]addadmin$") and is_iborn(msg) and msg.reply_to_message_id_ then
	...
	-----------------------------------------------------------------------------------------------
	if text:match("^[#!/]addadmin @(.*)$") and is_iborn(msg) then
	...
	-----------------------------------------------------------------------------------------------
	if text:match("^[#!/]remadmin @(.*)$") and is_iborn(msg) then
	local hash = 'bot:adminss:'
	...
	-----------------------------------------------------------------------------------------------
	if text:match("^[#!/]remadmin (%d+)$") and is_iborn(msg) then
	local hash = 'bot:adminss:'
...
*/del msg*
`برای پاک کردن تمامی پیام های گروه`
`لطفا در استفاده از این دستور دقت فرمایید`
